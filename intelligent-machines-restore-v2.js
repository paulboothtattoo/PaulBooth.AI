(() => {
  ...
  const installStyles = () => {
    if (document.getElementById("pb-machines-restore-styles-v2")) return;
    const style = document.createElement("style");
    style.id = "pb-machines-restore-styles-v2";
    style.textContent = `
  ...
  const render = () => {
    ...
    grid.dataset.pbMachinesOwner = "intelligent-machines-v2";
    ...
    grid.querySelectorAll(".pb-machine-poster").forEach((button) => {
      button.addEventListener("click", () => {
        ...
        const publicOrigin = "https://paulbooth.ai";
        const pageOrigin = (location.protocol === "http:" || location.protocol === "https:")
          ? location.origin
          : publicOrigin;
  ...
  const start = () => {
    ...
    const ensure = () => {
      ...
      const grid = document.getElementById("machine-grid");
      if (!grid) return;
      const owned = grid.dataset.pbMachinesOwner === "intelligent-machines-v2";
