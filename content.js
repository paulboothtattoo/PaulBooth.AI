/*
  Edit this file to replace placeholder content without touching the layout.
  category options: platform, vision, motion, research
*/
window.PB_CONTENT = {
  realms: [
  ...
  experiments: [
    {
      code: "EXP-001",
      title: "Zion Lost",
      description: "A unified archive for music, film, photography, and the evolving visual world of Zion Lost.",
      status: "Active",
      image: "projects/babylon-black/media/gallery/cover.png",
      link: "projects/babylon-black/index.html"
    }
  ],
  machines: []
};
